...
/**
 * A callback functioned that is executed when the SPICE server changes the
 * state of inputs modifiers, such as lock keys.
 * 
 * @param channel
 *     The channel on which the inputs modifiers signal was received.
 * 
 * @param client
