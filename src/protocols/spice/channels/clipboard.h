...
/**
 * Handler for clipboard data received via SPICE, invoked by the SPICE client
 * whenever text has been copied or cut within the SPICE session.
 *
 * @param client
 *     The SPICE client associated with the session in which the user cut or
 *     copied text.
 *
 * @param text
